...
export default function PortfolioV2() {
  ...
  const projects = [
    ...
    {
      title: "Confluence-C",
      description: "LandingPage criada para empresa de empreendedorismo feminino com o objetivo de divulgar eventos.",
      technologies: ["JavaScript", "HTML", "CSS"],
      image: "/3.png?height=200&width=350",
      github: "https://github.com/DevMarcelino/Confluence.test",
      demo: "https://devmarcelino.github.io/Confluence.test/",
    },
    {
      title: "AthenaConnect",
      ...
      demo: "https://athena-connect.vercel.app/",
    },
  ]
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-[#0f172a]/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 flex justify-between items-center h-16">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl hidden sm:block">Jonathas Marcelino</span>
          </div>
  ...
  <Button variant="outline" className="border-gray-300 dark:border-gray-700">
    Baixar CV
                ...
                <div className="mt-12 flex gap-4">
                  <a
                    href="https://github.com/DevMarcelino"
                  ...
                  <a
                    href="https://www.linkedin.com/in/jonathas-marcelino-oliveira"
                    className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400 transition-colors"
                  >
                    <Linkedin size={20} />
                  </a>
        ...
        <section id="projects" className="py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="text-3xl font-bold mb-4">Meus Projetos Recentes</h2>
              <p className="text-gray-600 dark:text-gray-300">
                Aqui está uma seleção de projetos nos quais trabalhei recentemente.
              </p>
            </div>
        ...
        <section id="education" className="py-20 bg-gray-100 dark:bg-gray-900/50">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <h2 className="text-3xl font-bold mb-4">Minha Formação Academica</h2>
              <p className="text-gray-600 dark:text-gray-300">Minha formação acadêmica e formação profissional.</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <span className="font-bold">Jonathas Marcelino</span>
            </div>

            <div className="text-gray-500 dark:text-gray-400 text-sm">
              © {new Date().getFullYear()} DevMarcelino. Todos os direitos reservados.
            </div>
